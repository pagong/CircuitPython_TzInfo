...
However, this ESP32-S3 board is not working properly with the Seengreat matrix adapter.
Due to a collision of IO pins the onboard PSRAM needs to be disabled.
